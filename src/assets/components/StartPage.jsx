...
export default function StartPage(props) {
  ...
  <section className='flex flex-col justify-between items-center w-full xl:flex-row lg:px-[15%] px-[5%]'>
  
    <div className='flex flex-col gap-4'>
    <h1 className='text-2xl xl:text-4xl text-[#111826] font-bold max-w-[535px]'>Reinvente seus estudos com provas feitas pela IA</h1>
